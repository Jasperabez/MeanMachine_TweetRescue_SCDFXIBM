    ...
    return (
      <div className={s.navPanel}>
        <div className={s.logoHolder}>
          <img className={s.logo} src="/assets/logo.svg" alt="" />
          <p className={s.name}>Tweet Rescue</p>
        </div>
        <div className={s.navHolder}>
          <div className={`${s.navLink} ${s.navLinkActive}`}>
            <svg
              className={s.navIcon}
              height="512pt"
              viewBox="0 0 512 512"
            ...
            <p className={s.navName}>Dashboard</p>
          </div>
          <div className={s.navLink}>
            ...
            <p className={s.navName}>All Tweets</p>
          </div>
        </div>
      </div>
    );
